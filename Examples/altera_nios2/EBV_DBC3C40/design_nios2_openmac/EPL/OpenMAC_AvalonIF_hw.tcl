...
# | Bernecker + Rainer 2010.02.24.13:24:15
# | OpenMAC with OpenHUB and OpenFILTER for Altera Nios II
# | 
# | C:/Projekte/EPL_V2/Examples/altera_nios2/EBV_DBC3C40/design_nios2_openmac/EPL/OpenMAC_AvalonIF.vhd
# | 
...
set_parameter_property MacTimer DEFAULT_VALUE true
...
set_parameter_property MacTimer HDL_PARAMETER true
...
set_interface_property Mii associatedClock clk_sink
set_interface_property Mii burstOnBurstBoundariesOnly false
set_interface_property Mii explicitAddressSpan 0
...
set_interface_property Mii writeWaitStates 1
...
set_interface_property DMA associatedClock clk_sink
...
set_interface_property RX associatedClock clk_sink
set_interface_property RX burstOnBurstBoundariesOnly false
set_interface_property RX explicitAddressSpan 0
...
set_interface_property REG associatedClock clk_sink
...
set_interface_property TimerCmp associatedClock clk_sink
set_interface_property TimerCmp burstOnBurstBoundariesOnly false
set_interface_property TimerCmp explicitAddressSpan 0
