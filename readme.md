...
Latest stable version: [2.3.1](\ref sect_revision_v2_3_1)
Current version: [2.3.1](\ref sect_revision_v2_3_1)
...
* Sourcecode: [tar.gz](http://downloads.sourceforge.net/project/openpowerlink/openPOWERLINK/V2.3.1/openPOWERLINK_V2.3.1.tar.gz)
