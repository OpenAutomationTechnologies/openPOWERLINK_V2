...
Current version: [2.4.1](\ref sect_revision_v2_4_1)
...
* Sourcecode: [tar.gz](http://downloads.sourceforge.net/project/openpowerlink/openPOWERLINK/V2.4.1/openPOWERLINK_V2.4.1.tar.gz)
