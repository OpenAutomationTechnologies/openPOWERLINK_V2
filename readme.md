...
Latest stable version: [2.7.2](\ref sect_revision_v2_7_2)
Current version: [2.7.2](\ref sect_revision_v2_7_2)
...
* Sourcecode: [tar.gz](http://downloads.sourceforge.net/project/openpowerlink/openPOWERLINK/V2.7.2/openPOWERLINK_V2.7.2.tar.gz)
