...
Latest stable version: [2.4.1](\ref sect_revision_v2_4_1)
Current version: [2.5.0](\ref sect_revision_v2_5_0)
...
* Sourcecode: [tar.gz](http://downloads.sourceforge.net/project/openpowerlink/openPOWERLINK/V2.5.0/openPOWERLINK_V2.5.0.tar.gz)
