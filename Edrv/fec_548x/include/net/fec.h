...
#define   FEC_BASE_ADDR_FEC0				(MCF_MBAR + 0x9000)
#define   FEC_BASE_ADDR_FEC1				(MCF_MBAR + 0x9800)

// Interrupt values
#define   INTC_IMRH_INT_MASK38				(0x00000040)
#define   INTC_IMRH_INT_MASK39				(0x00000080)
#define   INTC_ICR_FEC0						(0x30)
#define   INTC_ICR_FEC1						(0x31)
#define   GPIO_PAR_FECI2CIRQ_FEC0			(0xF000)
#define   GPIO_PAR_FECI2CIRQ_FEC			(0xFFC0)
...
#define   GPIO_PAR_FECI2CIRQ                *(volatile unsigned short*)(MCF_MBAR+0x000A44)

// FIFO read/write pointer
#define   FEC_FECTFRP(x)					*(volatile unsigned int*)(x + 0x1BC)
#define   FEC_FECTFWP(x)					*(volatile unsigned int*)(x + 0x1C0)
#define   FEC_FECTLRFP(x)					*(volatile unsigned int*)(x + 0x1B0)
#define   FEC_FECTLWFP(x)					*(volatile unsigned int*)(x + 0x1B4)
...
#define   FEC_EIR_RL                 		(0x00100000)   // collision retry limit
#define   FEC_EIR_HBERR		              	(0x80000000)   // heartbeat error
#define   FEC_EIR_BABR						(0x40000000)   // babbling receive error
#define   FEC_EIR_BABT						(0x20000000)   // babbling transmit error
#define   FEC_EIR_GRA						(0x10000000)   // graceful stop complete
...
#define   FEC_RX_DMA_PRI        			(6)  // a little bit lower priority than Rx
...
#define   FEC_MTU							(FEC_MAX_FRM_SIZE - 18)
#define   FEC_MAXBUF_SIZE					(1520)
#define   FEC_FLAGS_RCV_PROC				(0x00000001)
...
#define   FEC_GRA_TIMEOUT                   (1)
#else
#define   FEC_MII_TIMEOUT       	        2000/TIMER_PERIOD
#define   FEC_GRA_TIMEOUT       	        1000/TIMER_PERIOD
#endif

#define   FEC_FIFOPOINTERMASK               0x3FF
