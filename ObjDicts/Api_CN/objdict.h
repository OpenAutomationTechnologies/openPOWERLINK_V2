...
//            EPL_OBD_SUBINDEX_RAM_VAR(0x1020, 0x04, kEplObdTypUInt32, kEplObdAccRW, tEplObdUnsigned32, VerifyConfInvalid_U32, 1)
        ...
        EPL_OBD_BEGIN_INDEX_RAM(0x1C00, 0x04, NULL)
            ...
            EPL_OBD_SUBINDEX_RAM_USERDEF(0x1C00, 0x03, kEplObdTypUInt32, kEplObdAccRW, tEplObdUnsigned32, Threshold_U32, 0x1)
        ...
        EPL_OBD_BEGIN_INDEX_RAM(0x1C02, 0x04, NULL)
            ...
            EPL_OBD_SUBINDEX_RAM_USERDEF(0x1C02, 0x03, kEplObdTypUInt32, kEplObdAccRW, tEplObdUnsigned32, Threshold_U32, 0x1)
        EPL_OBD_END_INDEX(0x1C0F)
        ...
        EPL_OBD_RAM_INDEX_RAM_VARARRAY(0x1C09, 254, NULL, kEplObdTypUInt32, kEplObdAccRW, tEplObdUnsigned32, DLL_MNCNLossPResThreshold_AU32, 15)
#endif

        // Object 1C0Bh: DLL_CNLossSoC_REC
        EPL_OBD_BEGIN_INDEX_RAM(0x1C0B, 0x04, NULL)
            EPL_OBD_SUBINDEX_RAM_VAR(0x1C0B, 0x00, kEplObdTypUInt8, kEplObdAccConst, tEplObdUnsigned8, NumberOfEntries, 0x03)
            EPL_OBD_SUBINDEX_RAM_USERDEF_NOINIT(0x1C0B, 0x01, kEplObdTypUInt32, kEplObdAccRW, tEplObdUnsigned32, CumulativeCnt_U32)
            EPL_OBD_SUBINDEX_RAM_USERDEF(0x1C0B, 0x02, kEplObdTypUInt32, kEplObdAccR, tEplObdUnsigned32, ThresholdCnt_U32, 0x0)
            EPL_OBD_SUBINDEX_RAM_USERDEF(0x1C0B, 0x03, kEplObdTypUInt32, kEplObdAccRW, tEplObdUnsigned32, Threshold_U32, 0x1)
        EPL_OBD_END_INDEX(0x1C0B)

        // Object 1C0Dh: DLL_CNLossPReq_REC
        EPL_OBD_BEGIN_INDEX_RAM(0x1C0D, 0x04, NULL)
            EPL_OBD_SUBINDEX_RAM_VAR(0x1C0D, 0x00, kEplObdTypUInt8, kEplObdAccConst, tEplObdUnsigned8, NumberOfEntries, 0x03)
            EPL_OBD_SUBINDEX_RAM_USERDEF_NOINIT(0x1C0D, 0x01, kEplObdTypUInt32, kEplObdAccRW, tEplObdUnsigned32, CumulativeCnt_U32)
            EPL_OBD_SUBINDEX_RAM_USERDEF(0x1C0D, 0x02, kEplObdTypUInt32, kEplObdAccR, tEplObdUnsigned32, ThresholdCnt_U32, 0x0)
            EPL_OBD_SUBINDEX_RAM_USERDEF(0x1C0D, 0x03, kEplObdTypUInt32, kEplObdAccRW, tEplObdUnsigned32, Threshold_U32, 0x1)
        ...
        EPL_OBD_BEGIN_INDEX_RAM(0x1C0F, 0x04, NULL)
            ...
            EPL_OBD_SUBINDEX_RAM_USERDEF(0x1C0F, 0x03, kEplObdTypUInt32, kEplObdAccRW, tEplObdUnsigned32, Threshold_U32, 0x1)
        EPL_OBD_END_INDEX(0x1C0F)

        // Object 1C14h: DLL_LossOfFrameTolerance_U32 in [ns]
        EPL_OBD_BEGIN_INDEX_RAM(0x1C14, 0x01, EplApiCbObdAccess)
            EPL_OBD_SUBINDEX_RAM_VAR(0x1C14, 0x00, kEplObdTypUInt32, kEplObdAccRW, tEplObdUnsigned32, LossOfFrameTolerance, 300000)
        ...
        EPL_OBD_BEGIN_INDEX_RAM(0x1E40, 0x06, EplApiCbObdAccess)
            ...
            EPL_OBD_SUBINDEX_RAM_VAR(0x1E40, 0x05, kEplObdTypUInt32, kEplObdAccRW, tEplObdUnsigned32, DefaultGateway_IPAD, 0xC0A864FE)
        ...
        EPL_OBD_RAM_INDEX_RAM_ARRAY(0x1F26, EPL_NMT_MAX_NODE_ID, NULL, kEplObdTypUInt32, kEplObdAccRW, tEplObdUnsigned32, CFM_ExpConfDateList_AU32, 0)
        EPL_OBD_RAM_INDEX_RAM_ARRAY(0x1F27, EPL_NMT_MAX_NODE_ID, NULL, kEplObdTypUInt32, kEplObdAccRW, tEplObdUnsigned32, CFM_ExpConfTimeList_AU32, 0)
#endif

#if (((EPL_MODULE_INTEGRATION) & (EPL_MODULE_NMT_MN)) != 0)
        // Object 1F80h: NMT_StartUp_U32
        EPL_OBD_BEGIN_INDEX_RAM(0x1F80, 0x01, NULL)
            EPL_OBD_SUBINDEX_RAM_VAR(0x1F80, 0x00, kEplObdTypUInt32, kEplObdAccRW, tEplObdUnsigned32, NMT_StartUp_U32, 0x00)
        ...
        EPL_OBD_RAM_INDEX_RAM_ARRAY(0x1F84, 254, NULL, kEplObdTypUInt32, kEplObdAccRW, tEplObdUnsigned32, NMT_MNDeviceTypeIdList_AU32, 0)
        ...
        EPL_OBD_BEGIN_INDEX_RAM(0x1F89, 0x06, NULL)
            ...
            EPL_OBD_SUBINDEX_RAM_VAR(0x1F89, 0x01, kEplObdTypUInt32, kEplObdAccRW, tEplObdUnsigned32, MNWaitNotAct_U32, 1000000)        // in [us]
            EPL_OBD_SUBINDEX_RAM_VAR(0x1F89, 0x02, kEplObdTypUInt32, kEplObdAccRW, tEplObdUnsigned32, MNTimeoutPreOp1_U32, 500000)      // in [us]
            EPL_OBD_SUBINDEX_RAM_VAR(0x1F89, 0x03, kEplObdTypUInt32, kEplObdAccRW, tEplObdUnsigned32, MNWaitPreOp1_U32, 1000000)         // in [us]
            EPL_OBD_SUBINDEX_RAM_VAR(0x1F89, 0x04, kEplObdTypUInt32, kEplObdAccRW, tEplObdUnsigned32, MNTimeoutPreOp2_U32, 500000)      // in [us]
            EPL_OBD_SUBINDEX_RAM_VAR(0x1F89, 0x05, kEplObdTypUInt32, kEplObdAccRW, tEplObdUnsigned32, MNTimeoutReadyToOp_U32, 5000000)   // in [us]
        ...
        EPL_OBD_BEGIN_INDEX_RAM(0x1F8A, 0x06, NULL)
            ...
            EPL_OBD_SUBINDEX_RAM_VAR(0x1F8A, 0x01, kEplObdTypUInt32, kEplObdAccRW, tEplObdUnsigned32, WaitSoCPReq_U32, 1000)    // in [ns]
            EPL_OBD_SUBINDEX_RAM_VAR(0x1F8A, 0x02, kEplObdTypUInt32, kEplObdAccRW, tEplObdUnsigned32, AsyncSlotTimeout_U32, 100000) // in [ns]
        EPL_OBD_END_INDEX(0x1F8A)

        // Object 1F8Bh: NMT_MNPReqPayloadLimitList_AU16
        EPL_OBD_RAM_INDEX_RAM_ARRAY(0x1F8B, 254, NULL, kEplObdTypUInt16, kEplObdAccRW, tEplObdUnsigned16, NMT_MNPReqPayloadLimitList_AU16, 36)
#endif
        ...
        EPL_OBD_RAM_INDEX_RAM_ARRAY(0x1F92, 254, NULL, kEplObdTypUInt32, kEplObdAccRW, tEplObdUnsigned32, NMT_MNCNPResTimeout_AU32, 140000) // in [ns]
#endif
        ...
        EPL_OBD_BEGIN_INDEX_RAM(0x1F98, 0x09, NULL)
            ...
            EPL_OBD_SUBINDEX_RAM_VAR(0x1F98, 0x04, kEplObdTypUInt16, kEplObdAccRW, tEplObdUnsigned16, PReqActPayloadLimit_U16, 36)
            EPL_OBD_SUBINDEX_RAM_VAR(0x1F98, 0x05, kEplObdTypUInt16, kEplObdAccRW, tEplObdUnsigned16, PResActPayloadLimit_U16, 36)
            EPL_OBD_SUBINDEX_RAM_VAR(0x1F98, 0x06, kEplObdTypUInt32, kEplObdAccR, tEplObdUnsigned32, ASndMaxLatency_U32, 0x00)     // in [ns]
            EPL_OBD_SUBINDEX_RAM_VAR(0x1F98, 0x07, kEplObdTypUInt8, kEplObdAccRW, tEplObdUnsigned8, MultiplCycleCnt_U8, 0x00)
            EPL_OBD_SUBINDEX_RAM_VAR(0x1F98, 0x08, kEplObdTypUInt16, kEplObdAccRW, tEplObdUnsigned16, AsyncMTU_U16, EPL_C_DLL_MIN_ASYNC_MTU)
