...
//#if (((EPL_MODULE_INTEGRATION) & (EPL_MODULE_NMT_MN)) != 0)
        ...
        EPL_OBD_BEGIN_INDEX_RAM(0x2000, 0x03, NULL)
            ...
            EPL_OBD_SUBINDEX_RAM_USERDEF(0x2000, 0x01, 0x05, kEplObdAccVPRW, tEplObdUnsigned8, Sendb1, 0x0)
            EPL_OBD_SUBINDEX_RAM_USERDEF(0x2000, 0x02, 0x05, kEplObdAccVPRW, tEplObdUnsigned8, Sendb2, 0x0)
