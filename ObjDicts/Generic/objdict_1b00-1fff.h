...
//-----------------------------------------------------------------
        ...
        EPL_OBD_BEGIN_INDEX_RAM(0x1C00, 0x04, NULL)
            ...
            EPL_OBD_SUBINDEX_RAM_USERDEF(0x1C00, 0x03, kEplObdTypUInt32, kEplObdAccSRW, tEplObdUnsigned32, Threshold_U32, 0x1)
        ...
        EPL_OBD_BEGIN_INDEX_RAM(0x1C02, 0x04, NULL)
            ...
            EPL_OBD_SUBINDEX_RAM_USERDEF(0x1C02, 0x03, kEplObdTypUInt32, kEplObdAccSRW, tEplObdUnsigned32, Threshold_U32, 0x1)
        EPL_OBD_END_INDEX(0x1C0F)
        ...
        EPL_OBD_BEGIN_INDEX_RAM(0x1C0B, 0x04, NULL)
            ...
            EPL_OBD_SUBINDEX_RAM_USERDEF(0x1C0B, 0x03, kEplObdTypUInt32, kEplObdAccSRW, tEplObdUnsigned32, Threshold_U32, 0x1)
        ...
        EPL_OBD_BEGIN_INDEX_RAM(0x1C0D, 0x04, NULL)
            ...
            EPL_OBD_SUBINDEX_RAM_USERDEF(0x1C0D, 0x03, kEplObdTypUInt32, kEplObdAccSRW, tEplObdUnsigned32, Threshold_U32, 0x1)
        ...
        EPL_OBD_BEGIN_INDEX_RAM(0x1F89, 0x06, NULL)
            ...
            EPL_OBD_SUBINDEX_RAM_VAR(0x1F89, 0x05, kEplObdTypUInt32, kEplObdAccSRW, tEplObdUnsigned32, MNTimeoutReadyToOp_U32, 5000000)   // in [us]
