...
/*
 *  Define the UART register address offsets: 
 *
 *  Clarification: These are offset from MCFUART_BASE[1|2].  ~Jeremy
 *
 */
...
#define	MCFUART_UFPD		0x30		/* Fractional Baud Rate adjustment */
 ...
 */
#define	MCFUART_MR2_NORMAL	0x00		/* Normal mode */
#define	MCFUART_MR2_AUTOECHO	0x40		/* Automatic echo */
#define	MCFUART_MR2_LOOPBACK	0x80		/* Local loopback mode */
