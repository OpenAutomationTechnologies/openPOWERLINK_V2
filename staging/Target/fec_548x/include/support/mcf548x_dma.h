...
#define MCF_DMA_DIPR    (*(vuint32*)(void*)(MCF_MBAR+0x008014))
#define MCF_DMA_DIMR    (*(vuint32*)(void*)(MCF_MBAR+0x008018))
#define MCF_DMA_IMCR    (*(vuint32*)(void*)(MCF_MBAR+0x00805C))
